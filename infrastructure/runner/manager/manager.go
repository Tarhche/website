...
// 	"github.com/khanzadimahdi/testproject/domain/runner/scheduler"
...
// // 	SelectWorker(task.Task) (*node.Node, error)
// // 	UpdateTasks()
// // 	SendWork()
// // 	AddTask(task.Event)
// // 	GetTasks() []*task.Task
...
// func getHostPort(ports port.PortMap) *string {
// 	for k, _ := range ports {
...
// 		if ok {
// 			result, err := m.TaskDb.Get(te.Task.ID)
// 			if err != nil {
...
// 				m.stopTask(taskWorker, te.Task.ID)
// 				return
// 			}
